...
$lang = array_merge($lang, array(
	...
	'DIGESTS_LOWERCASE_DIGEST_TYPE_EXPLAIN'					=> 'V angličtině je nadpis souhrnů něco jako "Moje fórum - Denní Souhrn" ("Denní" a "Souhrn" s velkými písmeny na začátku). V některých jazycích je "Denní Souhrn" logicky na začátku nadpisu. Nastavíte-li na Ano, typ souhrn se uvede jako "Souhrn denní z mého fóra", s malým prvním písmenem v názvu fóra.',
	...
	'DIGESTS_SHOW_FORUM_PATH'								=> 'Zobrazot fórum i s cestou',
	'DIGESTS_SHOW_FORUM_PATH_EXPLAIN'						=> 'Je-li povoleno, zobrazí se v souhrnu fórum i s celou hierarchií nadřazených kategorií a fór, například: "Kategorie 1 :: Fórum 1 :: Kategorie A :: Fórum B". V opačném případně bude zobrazen pouze název fóra, v tomto případě "Forum B".',
	'DIGESTS_SORT_ORDER'									=> 'Třídění',
	'DIGESTS_STOPPED_SUBSCRIBING'							=> 'Přestal odebírat',
	'DIGESTS_STRIP_TAGS'									=> 'Zakázané HTML značky',
	'DIGESTS_STRIP_TAGS_EXPLAIN'							=> 'Některé HTML značky obsažené v příspěvcích mohu působít potíže. Některé mailove servery mohou emaily odmítnout doručit nebo je vyhodnotí jako spam. Uveďte značky (bez znaků &lt; a &gt;), které se mají vynechat, a oddělte je čárkami. Například "video,iframe". Nezakazujte značky jako h1, p nebo div, které jsou potřebné pro rozumné zobrazení souhrnů.',
