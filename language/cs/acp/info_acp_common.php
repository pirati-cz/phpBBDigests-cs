...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD'						=> array(
																1 => '<strong>Souhrn byl %1$s pro %2$s (%3$s) pro den %4$s a hodinu %5$d UTC. Obsahuje %6$d příspěvků a %7$d soukromých zpráv.</strong>',
																2 => '<strong>Souhrn byl %1$s pro %2$s (%3$s) pro den %4$s a hodinu %5$d UTC. Obsahuje %6$d příspěvků a %7$d soukromých zpráv.</strong>',
																3 => '<strong>Souhrn byl %1$s pro %2$s (%3$s) pro den %4$s a hodinu %5$d UTC. Obsahuje %6$d příspěvků a %7$d soukromých zpráv.</strong>'
															),
	...
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_GOOD_NO_EMAIL'			=> array(
																1 => '<strong>Souhrn byl %1$s pro %2$s pro den %3$s a hodinu %4$d UTC. Obsahuje %5$d příspěvků a %6$d soukromých zpráv.</strong>',
																2 => '<strong>Souhrn byl %1$s pro %2$s pro den %3$s a hodinu %4$d UTC. Obsahuje %5$d příspěvků a %6$d soukromých zpráv.</strong>',
																3 => '<strong>Souhrn byl %1$s pro %2$s pro den %3$s a hodinu %4$d UTC. Obsahuje %5$d příspěvků a %6$d soukromých zpráv.</strong>'
															),
	'LOG_CONFIG_DIGESTS_LOG_ENTRY_NONE'						=> '<strong>Souhrn příspěvků NEBYL poslán "%1$s" (%2$s), protože s použitím uživatelských nastavení nebyly nalezeny žádné příspěvky z zaslání.</strong>',
