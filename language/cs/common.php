...
$lang = array_merge($lang, array(
	...
	'DIGESTS_BAD_SEND_HOUR'				=> 'Uživatel: %s: hodina odesílání %s je neplatná. Měla by být >= 0 a < 24.',
	...
	'DIGESTS_DISCLAIMER'					=> 'Tento souhrn je zaslán registrovaným členům fóra <a href="%s">%s</a>. Zasílání souhrnu e-mailem můžete vypnout nebo upravit nastavení v <a href="%sucp.%s">Uživatelském panelu</a>. Máte-li nějaké dotazy či připomínky k souhrnům, obraťe se na <a href="mailto:%s">správce fóra %s</a>.',
	...
	'DIGESTS_INTRODUCTION' 				=> 'Zde je souhrn nejnovějších příspěvků zaslaných do fóra %s. Buďte vítáni a zapojte se do diskuze!',
	...
	'DIGESTS_LINK'						=> 'Odkaz',
	'DIGESTS_MARK_READ'					=> 'Označit příspěvky jako přečtené, když jsou mi zaslány v souhrnu',
	'DIGESTS_MAX_DISPLAY_WORDS'			=> 'Maximální počet slov z příspěvku',
	'DIGESTS_MAX_DISPLAY_WORDS_EXPLAIN'	=> 'Upozornění: Aby nedošlo k chybě formátování, tak se v případě krácení HTML formátování z příspěvku odstraní. Chcete-li zobrazit příspěvek celý, nechte políčko prázdné. Políčko ignorováno, pokud je nastavena volba "Vůbec nezobrazovat text příspěvků".',
	...
	'DIGESTS_PUBLISH_DATE'				=> 'Souhrn vytvořený přímo pro %s na %s',
	...
	'DIGESTS_SELECT_FORUMS_EXPLAIN'		=> 'Zde jsou zobrazena jen ta fóra, ke kterým máte oprávnění číst. Výběr fór není dostupný, pokud jste zvolili odběr pouze témat v záložkách.',
	...
	'DIGESTS_SUBJECT_TITLE'				=> '%s %s Souhrn emailem',
