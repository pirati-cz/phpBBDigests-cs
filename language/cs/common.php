...
$lang = array_merge($lang, array(
	...
	'DIGESTS_DISCLAIMER'				=> 'Tento souhrn je zaslán registrovaným členům fóra <a href="%1$s">%2$s</a>. Zasílání souhrnu e-mailem můžete vypnout nebo upravit nastavení v <a href="%1$sucp.%2$s">Uživatelském panelu</a>. Máte-li nějaké dotazy či připomínky k souhrnům, obraťe se na <a href="mailto:%1$s">správce fóra %2$s</a>.',
	...
	'DIGESTS_TRANSLATOR_CONTACT'		=> 'http://hendl.cz',	// Leave null string to suppress contact info, if used use: mailto:name@emailaddress.com or a URL if you have a website.
